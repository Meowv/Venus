...
public partial class it_dynamic : System.Web.UI.Page
{
    ...
    public void contrlRepeater()
    {
        ...
        ss = pb1.returnDs("SELECT articlesId,title,author,content,SUBSTRING(content2,0,220) as content2,CONVERT(varchar(100), pubTime, 23) as pubTime,kindArticles.kindName FROM articles INNER JOIN kindArticles ON articles.articleKindId = kindArticles.kindId where articleKindId=3 order by articlesId desc");
