...
public partial class admin_dailylist : System.Web.UI.Page
{
    ...
    private void Bind()
    {
        ...
        con.Open();
        string sqlShowInfo = "SELECT kindArticles.kindName,Articles.articlesId,Articles.title,Articles.author,Articles.content2,CONVERT(varchar(100), pubTime, 120) as pubTime,articles.articleKindId FROM Articles INNER JOIN kindArticles ON Articles.articleKindId = kindArticles.kindId WHERE articles.articleKindId = 1 order by articlesId desc";
    ...
    public void contrlRepeater()
    {
        ...
        ss = pb1.returnDs("select articlesId,SUBSTRING(content2,0,50) as content2,author,CONVERT(varchar(100), pubTime, 23) as pubTime from articles where articleKindId=1 order by articlesId desc");
