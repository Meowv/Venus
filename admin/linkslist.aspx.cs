...
public partial class admin_linkslist : System.Web.UI.Page
{
    ...
    private void Bind()
    {
        ...
        con.Open();
        string sqlShowInfo = "select linkID,name,url from Links ORDER BY linkID desc";
    ...
    public void contrlRepeater()
    {
        ...
        ss = pb1.returnDs("select linkID,name,url from Links order by linkID desc");
    ...
    protected void Repeater1_ItemCommand1(object source, RepeaterCommandEventArgs e)
    {
        if (e.CommandName == "delete")
        {
            SqlConnection con = new SqlConnection("Data Source=qds179471195.my3w.com;Initial Catalog=qds179471195_db;Persist Security Info=True;User ID=qds179471195;Password=wangjuyi110");
            con.Open();
            int linkID = int.Parse(e.CommandArgument.ToString());
            string sqlDel = "delete Links where linkID =" + linkID;
