<%@ Page Language="C#" AutoEventWireup="true" CodeFile="linkslist.aspx.cs" Inherits="admin_linkslist" %>
...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="admin.aspx">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">友链管理</span></div>
        </div>
                ...
                <div class="result-content">
                    ...
                    <table class="result-tab" width="80%">
                        <tr>
                            ...
                            <th class="style13">名称</th>
                            <th class="style14">链接</th>
                        ...
                        <tr>
                            ...
                            <td><%#Eval("url")%></td>
                            <td>
                                <asp:LinkButton ID="lbtnModify" runat="server" CommandName="modify" PostBackUrl='<%#string.Format("addLinks.aspx?id={0}",Eval(HttpUtility.UrlEncode("linkID")))%>'>修改</asp:LinkButton>
                                &nbsp;
                                <asp:LinkButton ID="lbtnDelete" OnClientClick="return confirm('你懂删除吗吗？')" CommandArgument='<%# Eval("linkID") %>' runat="server" CommandName="delete">删除</asp:LinkButton>
                            </td>
                        </tr>
                        </ItemTemplate>
                    </asp:Repeater>
