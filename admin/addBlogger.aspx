<%@ Page Language="C#" AutoEventWireup="true" CodeFile="addBlogger.aspx.cs" Inherits="admin_addBlogger" %>
...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="admin.aspx">首页</a><span class="crumb-step">&gt;</span><span>博主信息</span></div>
        </div>
                ...
                <form action="/jscss/admin/design/add" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        ...
                        <tr>
                            ...
                            <td><asp:FileUpload ID="FileUpload1" runat="server" name="smallimg" Width="250px" />
                            <asp:Button class="btn btn-primary btn6 mr10" ID="btnUpload" runat="server" 
                                        Text="上传" onclick="btnUpload_Click" Width="107px" />
                            <asp:Label ID="lblInfo" runat="server"></asp:Label>
                            <asp:Label ID="lblImgFile" runat="server" Visible="False"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="tbxOccupation" runat="server" Height="23px" Width="350px" class="common-text required"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>个人简介：</th>
                                <td><asp:TextBox ID="tbxIntroduction" runat="server" Height="23px" Width="350px" class="common-text required"></asp:TextBox></td>
                            </tr>
                            <tr>
                                <th></th>
                                <td>
