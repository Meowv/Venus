<%@ Page Language="C#" AutoEventWireup="true" CodeFile="dynamic.aspx.cs" Inherits="it_dynamic" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>IT动态-启明星博客</title>
...
<article class="blogs">
<h1 class="t_nav"><span>优雅、稳重、大气、低调，专注于教程分享-绿色软件-行业动态-软件开发技术-互联网资讯的专业博客！</span><a href="Default.aspx" class="n1">网站首页</a><a href="dynamic.aspx" class="n2">IT动态</a></h1>
<div class="bloglist left">
   ...
   <!--wz-->
    ...
    <p class="dateview"><span><%#Eval("pubTime") %></span><span>作者：<%#Eval("author") %></span><span>分类：[<a href="dynamic.aspx"><%#Eval("kindName") %></a>]</span></p>
    <figure>
    <a href="#">
 ...
 <div id="bdshare" class="bdshare_t bds_tools_32 get-codes-bdshare"><a class="bds_tsina"></a><a class="bds_qzone"></a><a class="bds_tqq"></a><a class="bds_renren"></a><span class="bds_more"></span><a class="shareCount"></a></div>
   <div class="rnav">
      <ul>
       ...
       <li class="rnav2"><a href="dynamic.aspx">技术教程</a></li>
